...
stage('Build image') {
/* Builds the image; synonymous to docker image build on the command
line */
/* Use a registry name if pushing into docker hub or your company
registry, like this */
...
/* This would probably be docker hub or your company registry, like
this */
